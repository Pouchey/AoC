export function Header() {
  return (
    <header className="relative text-center py-8 mb-8">
      {/* Glow effect */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[200px] bg-[radial-gradient(ellipse_at_center,rgba(59,185,80,0.15)_0%,transparent_70%)] pointer-events-none" />
